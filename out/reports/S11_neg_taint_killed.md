...
- **运行 ID**：`run_20260920_104200_S11_neg_taint_killed`
- **分析路线**：S11_neg_taint_killed / 思路 B
- **耗时**：0.59 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S11_neg_taint_killed.bin` |
| sha256 | `d240af77956529d681443d335fa3758e6e7a356854cb3d8b2d08a6c6572c10a5` |
| size | `20` |
| format | `bin` |
| arch | `riscv32` |
...
| 地址 | 关键指令 | 说明 |
|---|---|---|
| `0x80000000` | `divu arith_div` | 操作数恒为常量：常量折叠后触发条件无法由外部输入满足 |
...
```json
{
  "run_id": "run_20260920_104200_S11_neg_taint_killed",
  "firmware_sha256": "d240af77956529d681443d335fa3758e6e7a356854cb3d8b2d08a6c6572c10a5",
