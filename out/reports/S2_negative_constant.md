...
- **运行 ID**：`run_20260920_104154_S2_negative_constant`
- **分析路线**：S2_negative_constant / 思路 B
- **耗时**：0.64 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S2_negative_constant.bin` |
| sha256 | `1791ce55b0676f421cc276c72f2f2bd2b35c6d7ead277a0ee6ff4ba29b5b54b4` |
| size | `16` |
| format | `bin` |
| arch | `riscv32` |
...
```json
{
  "run_id": "run_20260920_104154_S2_negative_constant",
  "firmware_sha256": "1791ce55b0676f421cc276c72f2f2bd2b35c6d7ead277a0ee6ff4ba29b5b54b4",
