...
- **运行 ID**：`run_20260920_104159_S10_neg_dead_after_ret`
- **分析路线**：S10_neg_dead_after_ret / 思路 B
- **耗时**：0.75 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S10_neg_dead_after_ret.bin` |
| sha256 | `fd36568de858aea521680f91ef8a0db0e178f81fb7b6a92c904d575541998bf4` |
| size | `12` |
| format | `bin` |
| arch | `riscv32` |
...
| 地址 | 关键指令 | 说明 |
|---|---|---|
| `0x80000004` | `divu arith_div` | 触发片段存在于不可达基本块 bb_80000004（地址 0x80000004），无法从任何外部输入入口到达 |
...
```json
{
  "run_id": "run_20260920_104159_S10_neg_dead_after_ret",
  "firmware_sha256": "fd36568de858aea521680f91ef8a0db0e178f81fb7b6a92c904d575541998bf4",
