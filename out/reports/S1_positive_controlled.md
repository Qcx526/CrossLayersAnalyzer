...
- **运行 ID**：`run_20260920_104152_S1_positive_controlled`
- **分析路线**：S1_positive_controlled / 思路 B
- **耗时**：1.62 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S1_positive_controlled.bin` |
| sha256 | `80273ca49671006019828aeb0bc3e289421df4a88a0f865d595a942d1899c0a7` |
| size | `24` |
| format | `bin` |
| arch | `riscv32` |
...
```json
{
  "run_id": "run_20260920_104152_S1_positive_controlled",
  "firmware_sha256": "80273ca49671006019828aeb0bc3e289421df4a88a0f865d595a942d1899c0a7",
