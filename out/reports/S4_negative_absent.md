...
- **运行 ID**：`run_20260920_104155_S4_negative_absent`
- **分析路线**：S4_negative_absent / 思路 B
- **耗时**：0.55 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S4_negative_absent.bin` |
| sha256 | `4e79de57b301a7e0dc3ab18060e801a2917bfcd18f74abaacef28c630a7eea7c` |
| size | `20` |
| format | `bin` |
| arch | `riscv32` |
...
| 地址 | 说明 |
|---|---|
| `0x80000000` | 全程序范围内未出现触发事件要求的操作类别 ['arith_div']，触发片段不存在 |
...
```json
{
  "run_id": "run_20260920_104155_S4_negative_absent",
  "firmware_sha256": "4e79de57b301a7e0dc3ab18060e801a2917bfcd18f74abaacef28c630a7eea7c",
