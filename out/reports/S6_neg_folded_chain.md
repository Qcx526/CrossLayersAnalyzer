...
- **运行 ID**：`run_20260920_104157_S6_neg_folded_chain`
- **分析路线**：S6_neg_folded_chain / 思路 B
- **耗时**：0.68 s
...
| 字段 | 值 |
|---|---|
| path | `F:\qcx\code\CrossLayersAnalyzer\out\samples\S6_neg_folded_chain.bin` |
| sha256 | `685071f7b199ab9c7c28c897c893ef6399526f35cb56cdf59bf44591ab2ecff8` |
| size | `24` |
| format | `bin` |
| arch | `riscv32` |
...
```json
{
  "run_id": "run_20260920_104157_S6_neg_folded_chain",
  "firmware_sha256": "685071f7b199ab9c7c28c897c893ef6399526f35cb56cdf59bf44591ab2ecff8",
